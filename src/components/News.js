...
export function News(props){
  ...
  const fetchMoreData = async() => {
    ...
    return (
      <>
      <div class="content dim d-flex flex-column justify-content-center align-items-center text-center content-container">
        <h1 class="display-4">Welcome to NewsNest</h1>
        <p class="lead">
        ...
        <a class="btn btn-lg btn-style" href="/" role="button"><b>Read More</b></a>
      </div>
        <h2
